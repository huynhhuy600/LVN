		...
		while($row = $get_recent->fetch_assoc()) {
			...
			$result .= "<div class='parallax_item'>
							...
							<div class='detail'>
								...
								<p class='price'>VNĐ".$row['food_price']."</p>
...
<div class="content remove_pad" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Món Mới </span></h2>
	...
	<div class="inner_content">
		...
		<div class="contact">
			...
			<div class="left">
				...
				<h3>LOCATION</h3>
				<p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Temporibus consectetur quasi laudantium exercitationem fugit possimus provident qui accusantium non praesentium! Ab nihil perferendis commodi labore, velit doloremque accusantium tempore deserunt?</p>
			...
			<div class="icon_holder">
				...
				<a href="fb.com"><img src="image/icons/Facebook.png" alt="image/icons/Facebook.png" /></a>
				<a href="gmail.com"><img src="image/icons/Google+.png" alt="image/icons/Google+.png"  /></a>
