			...
			if($row['food_category'] == "breakfast") {
				...
				$bfast .= "<div class='parallax_item'>
							...
							<div class='detail'>
								...
								<p class='price'>VND".$row['food_price']."</p>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Đồ ăn sáng </span></h2>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Đồ ăn Trưa</span></h2>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Đồ ăn tối</span></h2>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Đặc biệt</span></h2>
